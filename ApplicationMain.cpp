...
//  Project     : Application
//  Framework   : Framework for the projects 04
...
{
	cout<<"\n\n";
	cout<<"\t\t_________________ The Project of Application  ____________"<<endl;
	cout<<"\n";
	cout<<"\t\t***************************************************************"<<endl;
	cout<<"\t\t************************   M E N U  ***************************"<<endl;
	cout<<"\t\t***************************************************************"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     1. [ The Chess Board Game ]                             *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     2. [ Analysis of Character ]                            *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     3. [ Factorization ]                                    *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     4. [ 3 Children & 5 Books  ]                            *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     5. [ Multiplication Table (9x9) ]                       *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     6. [ The Criminal's Car Plate ]                         *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     7. [ $50 & 50 Chickens ]                                *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*     8.  Exit                                                *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
	cout<<"\t\t*                                                             *"<<endl;
